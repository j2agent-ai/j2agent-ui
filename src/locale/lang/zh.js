...
export default {
	...
	'files.modified': '修改时间',
	'files.status': '状态',
	'files.sync.scan': '扫描 OSS 与数据库',
	'files.sync.scanned': '已扫描',
	'files.sync.diff.type': '差异类型',
	'files.sync.oss.info': 'OSS 信息',
	'files.sync.db.info': 'DB 信息',
	'files.sync.etag': 'ETag',
	'files.sync.diff.IN_SYNC.help': 'OSS 与数据库均存在，且 ETag、文件大小、最后修改时间一致。',
	'files.sync.diff.OSS_ONLY.help': '文件仅存在于 OSS，对应的数据库台账记录不存在。',
	'files.sync.diff.DB_ONLY.help': '仅存在数据库台账记录，OSS 中的文件已经不存在。',
	...
	'files.sync.start.failed': '启动扫描失败，可能已有任务正在运行',
	'files.sync.load.failed': '加载同步差异失败',
	'files.sync.delete.confirm': '该操作会删除对象存储或数据库中的数据，是否继续？',
