...
export default {
	...
	'nms.config.title': 'NMS Connection Config',
	'nms.config.placeholder': 'Enter NMS config JSON, e.g. {"datasource":{"jdbcUrl":"","username":"","password":"","driverClassName":"com.mysql.cj.jdbc.Driver"},"service":{"baseUrl":""}}',
	'nms.config.format': 'Format',
	'nms.config.invalid': 'Invalid JSON format',
	'nms.config.load.failed': 'Failed to load NMS config',
